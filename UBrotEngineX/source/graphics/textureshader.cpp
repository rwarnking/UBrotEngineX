...
///////////////////////////////////////////////////////////////////////////////////////////////////
#include "../../header/graphics/textureshader.h"
...
bool TextureShader::InitializeShader(ID3D11Device *device, HWND hwnd)
{
	...
	result = D3DCompileFromFile(
		L"../UBrotEngineX/shader/texture.vs", NULL, NULL, "TextureVertexShader", "vs_5_0",
		D3D10_SHADER_ENABLE_STRICTNESS, 0, &vertexShaderBuffer, &errorMessage);
	if (FAILED(result))
	{
		if (errorMessage)
		{
			OutputShaderErrorMessage(errorMessage, hwnd, L"../UBrotEngineX/shader/texture.vs");
		}
		else
		{
			MessageBox(hwnd, L"../UBrotEngineX/shader/texture.vs", L"Missing Shader File", MB_OK);
		}
	...
	result = D3DCompileFromFile(
		L"../UBrotEngineX/shader/texture.fs", NULL, NULL, "TextureFragmentShader", "ps_5_0",
		D3D10_SHADER_ENABLE_STRICTNESS, 0, &pixelShaderBuffer, &errorMessage);
	if (FAILED(result))
	{
		if (errorMessage)
		{
			OutputShaderErrorMessage(errorMessage, hwnd, L"../UBrotEngineX/shader/texture.fs");
		}
		else
		{
			MessageBox(hwnd, L"../UBrotEngineX/shader/texture.fs", L"Missing Shader File", MB_OK);
		}
...
bool XM_CALLCONV TextureShader::Render(
